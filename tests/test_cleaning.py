...
def test_clean_customers_removes_duplicate_customer_ids():
    raw = pd.DataFrame(
        [
            {"customer_id": " c-001 ", "customer_name": "alice", "segment": "consumer", "country": "egypt", "city": "cairo", "signup_date": "2025-01-01"},
            {"customer_id": "C-001", "customer_name": "alice duplicate", "segment": "consumer", "country": "egypt", "city": "cairo", "signup_date": "2025-01-01"},
        ]
    )
...
def test_clean_orders_calculates_revenue_and_flags_invalid_rows():
    ...
    raw = pd.DataFrame(
        [
            {"order_id": "O-001", "order_date": "2025-01-01", "customer_id": "C-001", "product_id": "P-001", "quantity": 2, "discount": 0.1, "unit_price": 100.0, "status": "completed"},
            {"order_id": "O-002", "order_date": "2025-01-02", "customer_id": "C-999", "product_id": "P-001", "quantity": 1, "discount": 0, "unit_price": 100.0, "status": "completed"},
            {"order_id": "O-003", "order_date": "2025-01-03", "customer_id": "C-001", "product_id": "P-001", "quantity": -1, "discount": 0, "unit_price": 100.0, "status": "completed"},
        ]
    )
...
def test_clean_products_standardizes_categories():
    raw = pd.DataFrame(
        [{"product_id": "p-001", "product_name": "keyboard", "category": "ELECTRONICS", "unit_cost": "50", "unit_price": "80"}]
    )
